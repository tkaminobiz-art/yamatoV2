          ...
          <section className="mb-20 md:mb-28" aria-labelledby="philosophy-heading">
            ...
            <div className="rounded-2xl p-8 md:p-12" style={{
              ...
              <p style={{
                ...
                「家族の要の家造り」家族の数だけある理想をカタチにするため、日々企業努力を惜しみません。<br /><br />
                一戸建てはもちろん、土地、収益物件、店舗物件などあらゆる面でお客様をサポートします。
                様々なニーズに対応できるよう多数の物件を用意しております。<br /><br />
                大手ハウスメーカーの中間マージンを省き、材料から職人まで直接関与することで、
                大手と同等の品質を適正価格でお届けする。それが私たちの使命です。
              </p>
            </div>
          </section>
